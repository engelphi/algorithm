...
TEST_CASE("zip_with", "[zip_with]") {
    SECTION("zip_with should zip containers with given operators") {
        SECTION("vectors") {
            ...
            algo::zip_with(first_range.begin(), first_range.end(),
                           second_range.begin(),
        ...
        SECTION("forward_list") {
            ...
            algo::zip_with(first_range.begin(), first_range.end(),
                           second_range.begin(), result_range.begin(),
                           [](const auto &first, const auto &second) {
                               return first + second;
                           });
    ...
    SECTION("zip_with should zip containers with given operators and different "
        ...
        SECTION("forward_list") {
            ...
            result_range.resize(5);
            std::forward_list<std::string> expected_result{
